...
This project listens to an IBM MQ message, parse & process the message and writes into a kafka topic.
It makes use of Micronaut for Spring framework.
...
- Conductor platform( Optional UI to see Kafka messages)
